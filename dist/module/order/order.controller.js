...
const orderSingleBook = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const order = req.body;
        const result = yield order_service_1.default.orderSingleBookService(order);
...
const totalRevenue = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const result = yield order_service_1.default.calculateRevenue();
        res.status(200).json({
            success: true,
