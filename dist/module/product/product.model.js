...
const BookModelSchema = new mongoose_1.Schema({
    title: {
        type: String,
    ...
    category: {
        ...
        enum: {
            ...
            message: 'please chose between (Fiction, Science, SelfDevelopment, Poetry, Religious) ',
        },
    },
    description: {
        type: String,
...
const BookProductModelSchema = (0, mongoose_1.model)('Book', BookModelSchema);
exports.default = BookProductModelSchema;
// Product Model (Book)
